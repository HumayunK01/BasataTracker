...
export function IndexableEntryDialog({ open, onOpenChange, row, accountId }: IndexableEntryDialogProps) {
  ...
  const [step1, setStep1] = useState<IndexableStepStatus>("Pending");
  ...
  const save = () => {
    ...
    const s2 = step2Disabled ? null : (step2 === NONE ? null : (step2 as IndexableStepStatus));
    const s3 = step3Disabled ? null : (step3 === NONE ? null : (step3 as IndexableStepStatus));
    upsert.mutate(
      {
        id: row?.id,
        accountId,
      ...
      <DialogContent className="sm:max-w-md bg-background/95 backdrop-blur-lg">
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-1.5">
            <Label htmlFor="indexable-name" className="text-xs font-semibold text-muted-foreground">Patient Name</Label>
            <Input
              id="indexable-name"
          ...
          <div className="space-y-1.5">
            <Label htmlFor="indexable-notes" className="text-xs font-semibold text-muted-foreground">Notes</Label>
            <Textarea
              id="indexable-notes"
